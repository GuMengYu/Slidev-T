...
let scene, camera, renderer, controls, bulbLight, bulbMaterial, hemiLight, floorMaterial, earthMaterial, cubeMaterial
...
function init(_container) {
  ...
  // 相机
  camera = new PerspectiveCamera(50, _container.clientWidth / _container.clientHeight, 0.1, 100)
  ...
  window.addEventListener('resize', windowResize.bind(null, _container))
  render()
...
function windowResize(container: HTMLElement) {
